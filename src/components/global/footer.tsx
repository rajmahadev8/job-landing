...
const Footer = () => {        
    return (
        <section className="py-10 bg-dark sm:pt-16 lg:pt-24 w-[inherit]">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="">
            <div className="flex flex-row justify-between items-center">
            <p className="text-3xl font-bold">MyAiJobs</p>

               
                <ul className="flex items-center space-x-3 ">
                    <li>
                        <a href="#" title="" className="flex items-center justify-center text-dark transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
            ...
            {/* <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                ...
                <form action="#" method="POST" className="mt-6">
                    ...
                    <button type="submit" className="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-dark transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:bg-blue-700">Subscribe</button>
                </form>
            </div> */}
        </div>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by MyAiJobs{/*  */}</p>
    </div>
</section>
